...
// change coresponding variables since we wants the graph to shows different value
...
export class DataManipulator {
  static generateRow(serverRespond: ServerRespond[]): Row {
    ...
    const priceDEF =
      ...
      // set ratio, upper & lower bound to determine trigger_alert later
